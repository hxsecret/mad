...
\begin{table}[h!]
    \scriptsize
    \centering
    \caption{Detection performance of MAD and baselines on the in-the-wild MalHug dataset (78 malicious models and 11 benign models).}
    ...
    \SetCell[r = 1, c = 1]{c} \textbf{Method} & \SetCell[r = 1, c = 1]{c} \textbf{Precision} & \SetCell[r = 1, c = 1]{c} \textbf{Recall} & \SetCell[r = 1, c = 1]{c} \textbf{F1} \\ \hline
    \SetCell[r = 1, c = 1]{c} \textbf{JFrog} & 0.8953 & 0.9872 & 0.9390 \\
    \SetCell[r = 1, c = 1]{c} \textbf{Protect AI} & 0.8966 & \textbf{1.0000} & 0.9455 \\
    \SetCell[r = 1, c = 1]{c} \textbf{ClamAV} & 0.8904 & 0.8333 & 0.8609 \\
    \SetCell[r = 1, c = 1]{c} \textbf{TensorAbuse} & 0.0000 & 0.0000 & 0.0000 \\ \hline
    \SetCell[r = 1, c = 1]{c} \textbf{MAD} & \textbf{1.0000} & 0.9744 & \textbf{0.9870} \\
    \end{tblr} }
