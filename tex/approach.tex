...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=\linewidth]{figs/overview4.pdf}
...
\begin{table}[t!]
	...
	\begin{tabular}{p{0.10\columnwidth} p{0.28\columnwidth} p{0.47\columnwidth}}
		\hline
